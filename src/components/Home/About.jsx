            ...
            <Row>
              <Col md={8} className="home-about-description">
                ...
                <p className="home-about-body">
                 Hi, my name is <span className="yellow">Aryan Rajpoot </span>
                ...
                <br />
                  As a
                  <b className="yellow"> MERN </b>developer,  
              ...
              <Col md={12} className="home-about-social">
                ...
                <ul className="home-about-social-links">
                  <li className="social-icons">
                    <a
                      href="https://github.com/aryanrajpoot27"
                      target="_blank"
                      rel="noreferrer"
                  ...
                  <li className="social-icons">
                    <a
                      href="https://twitter.com/aryanrajpoot27"
                      target="_blank"
                      rel="noreferrer"
                      className="icon-colour  home-social-icons"
                      aria-label="twitter"
                  ...
                  <li className="social-icons">
                    <a
                      href="https://www.linkedin.com/in/aryanrajpoot27/"
                      target="_blank"
                      rel="noreferrer"
                      className="icon-colour  home-social-icons"
                      aria-label="linkedin"
                  ...
                  <li className="social-icons">
                    <a
                      href="https://www.instagram.com/aryannn2710/"
                      target="_blank"
                      rel="noreferrer"
                      className="icon-colour home-social-icons"
